...
>   ```
>
>   >1. p是单词 paragraph的缩写，意为段落。
>   >
>   >2. 标签语义：可以把HTML文档分割为若干段落
>   >
>   >3. 特点：
...
>   >```
>   >
>   >>1. 单词break的缩写，意为打断、换行
>   >>
>   >>2. 标签语义：强制换行
>   >>
>   >>3. 特点：
>   >>   >1. br是个单标签
>   >>   >2. br标签只是简单地开始新的一行，跟段落不一样，段落之间会插入一些垂直的距离
...
>>1. ##### 图像标签
>>
>>   >1. 在HTML标签中，**<img>标签**用于定义HTML页面中的图像。
>>   >
>>   >   ```html
>>   >    <img src="图像URL" />
>>   >   ```
...
>#### 1.注释
>
>>1. 如果需要在HTML文档中添加一些便于阅读和理解但又不需要显示在页面中的注释文字，就需要使用注释标签
>>
>>2. HTML中的注释以“**<!--开头，以-->**”结束
>>
>>3. **<!--注释语句-->**
...
>#### 2.特殊字符
>
>>1. 在HTML页面中，一些特俗的符号很难或者不方便直接使用，此时我们就可以使用下面的字符来替代
>>
